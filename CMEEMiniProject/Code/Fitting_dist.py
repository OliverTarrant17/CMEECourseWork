...
for g in list_of_inputs:
    with gzip.open(g,'rb') as genos: # For each file
    ...
    for depths in Depth:
        ...
        Neg_Binom_Params_1.add('p1',value=1-np.percentile(depths,50)/(sum(depths)/(40)),min=0.001,max=1)
        
        Neg_Binom_Params_2=lmfit.Parameters()
        Neg_Binom_Params_2.add('n1',value=sum(depths)/(2*40),min=1)
        Neg_Binom_Params_2.add('p1',value=1-np.percentile(depths,33)/(sum(depths)/(2*40)),min=0.001,max=1)
        Neg_Binom_Params_2.add('n2',value=sum(depths)/(2*40),min=1)
        Neg_Binom_Params_2.add('p2',value=1-np.percentile(depths,66)/(sum(depths)/(2*40)),min=0.001,max=1)        
        ...
        Neg_Binom_Params_3.add('p1',value=1-np.percentile(depths,25)/(sum(depths)/(3*40)),min=0.001,max=1)
        Neg_Binom_Params_3.add('n2',value=sum(depths)/(3*40),min=1)
        Neg_Binom_Params_3.add('p2',value=1-np.percentile(depths,50)/(sum(depths)/(3*40)),min=0.001,max=1)
        Neg_Binom_Params_3.add('n3',value=sum(depths)/(3*40),min=1)
        Neg_Binom_Params_3.add('p3',value=1-np.percentile(depths,75)/(sum(depths)/(3*40)),min=0.001,max=1)        
        ...
        Neg_Binom_Params_4.add('p1',value=1-np.percentile(depths,20)/(sum(depths)/(4*40)),min=0.001,max=1)
        Neg_Binom_Params_4.add('n2',value=sum(depths)/(4*40),min=1)
        Neg_Binom_Params_4.add('p2',value=1-np.percentile(depths,40)/(sum(depths)/(4*40)),min=0.001,max=1)
        Neg_Binom_Params_4.add('n3',value=sum(depths)/(4*40),min=1)
        Neg_Binom_Params_4.add('p3',value=1-np.percentile(depths,60)/(sum(depths)/(4*40)),min=0.001,max=1)
        Neg_Binom_Params_4.add('n4',value=sum(depths)/(4*40),min=1)
        Neg_Binom_Params_4.add('p4',value=1-np.percentile(depths,80)/(sum(depths)/(4*40)),min=0.001,max=1)        
        ...
        Neg_Binom_Params_5.add('p1',value=1-np.percentile(depths,17)/(sum(depths)/(5*40)),min=0.001,max=1)
        Neg_Binom_Params_5.add('n2',value=sum(depths)/(5*40),min=1)
        Neg_Binom_Params_5.add('p2',value=1-np.percentile(depths,33)/(sum(depths)/(5*40)),min=0.001,max=1)
        Neg_Binom_Params_5.add('n3',value=sum(depths)/(5*40),min=1)
        Neg_Binom_Params_5.add('p3',value=1-np.percentile(depths,50)/(sum(depths)/(5*40)),min=0.001,max=1)
        Neg_Binom_Params_5.add('n4',value=sum(depths)/(5*40),min=1)
        Neg_Binom_Params_5.add('p4',value=1-np.percentile(depths,67)/(sum(depths)/(5*40)),min=0.001,max=1)
        Neg_Binom_Params_5.add('n5',value=sum(depths)/(5*40),min=1)
        Neg_Binom_Params_5.add('p5',value=1-np.percentile(depths,84)/(sum(depths)/(5*40)),min=0.001,max=1)          
        ...
        filename="Parameters_Sample_%d" %Sample
