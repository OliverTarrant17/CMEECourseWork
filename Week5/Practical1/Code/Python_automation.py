...
bioclimVars = ['../Data/EU/bio1', '../Data/EU/bio12']
...
cmd = ('gdal_translate -projwin 2800000.0 4200000.0 4000000.0 3000000.0 '
       '-of GTiff ../Data/EU/g250_06.tif ../Data/EU/g250_06_UK.tif')
os.system(cmd)

# - reproject and resample into a 2 km grid
cmd = ('gdalwarp -overwrite -s_srs EPSG:3035 -t_srs EPSG:27700 -r near '
       '-of GTiff -tr 2000 2000 -te -220000 -10000 680000 1080000 '
       '../Data/EU/g250_06_UK.tif ../Data/EU/g250_06_UK_BNG.tif')
os.system(cmd)

# tidy up the intermediate files
intermediates = ['../Data/EU/g250_06_UK.tif','../Data/EU/bio1_merge.tif', '../Data/EU/bio1_UK.tif',
                 '../Data/EU/bio12_merge.tif', '../Data/EU/bio12_UK.tif']
...
landcover = gdal.Open('../Data/EU/g250_06_UK_BNG.tif')
